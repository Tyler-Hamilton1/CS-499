...
void SceneManager::LoadSceneTextures()
{
	...
	this->CreateGLTexture("Utilities/textures/bricks.jpg", "Bricks");

	this->CreateGLTexture("Utilities/textures/tile.jpg", "Tile");

	this->CreateGLTexture("Utilities/textures/wood.jpg", "Wood");

	this->CreateGLTexture("Utilities/textures/plastic.jpg", "Plastic");

	this->CreateGLTexture("Utilities/textures/whitePlastic.jpg", "WhitePlastic");

	this->CreateGLTexture("Utilities/textures/blackPlastic.jpg", "BlackPlastic");

	this->CreateGLTexture("Utilities/textures/rubix.png", "Rubix");

	this->CreateGLTexture("Utilities/textures/kvm.jpg", "Black");
...
void SceneManager::DefineObjectMaterials()
{
	...
	plasticMaterial.diffuseColor = glm::vec3(0.8f, 0.4f, 0.8f);
	plasticMaterial.specularColor = glm::vec3(0.2f, 0.2f, 0.2f);
	plasticMaterial.shininess = 4.0;
	plasticMaterial.tag = "reflect";
...
void SceneManager::PrepareScene()
{
	...
	m_basicMeshes->LoadTaperedCylinderMesh(1.0f, 0.6f, 1.0f, 36);
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 3.00f, 0.0f);
...
// set the XYZ scale for the mesh
	...
	// set the active color values in the shader (RGBA)
	SetShaderColor(1, 1, 1, 1);
	SetShaderTexture("Rubix");
	SetShaderMaterial("plastic");

	SetTextureUVScale(1.0f, 1.0f);
	// draw a filled box shapew
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.0f, 1.0f, 0.7f);
...
/******************************************************************/
// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 1.0f, 0.7f);
